...
* The original package name 'com.ailegorreta.test-service-reactive' is invalid and this project uses 'com.ailegorreta.testservicereactive' instead.

# Getting Started

Main difference with `test-service` is that this service utilizes the R2DBC driver
instead the Postgres JDBC driver.

see: page 260 of the Cloud Native Applications book.
